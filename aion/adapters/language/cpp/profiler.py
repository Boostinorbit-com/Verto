...
When a file has several optimization candidates, AION must optimize the one that
...
AION_Surfaces / AION_Architecture §11 (Evidence).
"""
...
def profile_functions(source: str, funcs: list[str], *, n: int = 200_000) -> dict[str, float]:
    with tempfile.TemporaryDirectory(prefix="aion-prof-") as wd:
