...
from boostopt.adapters.language.cpp.regex_detect import (
...
def test_1b_tolerant_compare():
    from boostopt.adapters.domain.performance.correctness import _outputs_match
...
def test_1a_tsan_catches_race_when_available():
    ...
    from boostopt.adapters.language.cpp.build import tsan_toolchain
