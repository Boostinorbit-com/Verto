...
Mirrors BOOSTOPT_Architecture §16.1 and the Evidence stage (§8①). It is GENERIC over
...
class CppSensor:
    ...
    def collect(self, target: Target, exclude: frozenset[str] = frozenset()) -> Evidence:
        ...
        # keep only what BOOSTOPT can harness AND soundly verify; skip the rest with a
