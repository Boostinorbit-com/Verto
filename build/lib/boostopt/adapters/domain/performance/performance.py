...
Mirrors BOOSTOPT.md §9.3 and BOOSTOPT_Architecture §16.5. Benchmarks the original and
...
class PerformanceOracleImpl:
    ...
    def compare(self, orig: Target, var: Variant, ctx: object | None = None) -> PerfVerdict:
        ...
        own_wd = tempfile.mkdtemp(prefix="boostopt-perf-") if ctx is None else None
