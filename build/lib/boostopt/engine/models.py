"""BOOSTOPT data schemas — the objects that flow through the four-stage loop.

Mirrors BOOSTOPT_Architecture §6/§7. These are language-agnostic; per-language
...
@dataclass
class Skip:
    """A candidate site BOOSTOPT saw but did NOT optimize, and why (Phase-1 item #4).
