...
// A function BOOSTOPT can harness (size_t -> vector<int>) with a reserve opportunity.
...
// the project's real acceptance criteria, not just BOOSTOPT's synthetic inputs.
