...
// scaled takes a std::map parameter — which BOOSTOPT CANNOT synth-harness — so without 2A
...
// (perf), BOOSTOPT verifies the reserve() change against the project's OWN test + bench —
