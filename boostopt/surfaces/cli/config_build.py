...
def _build_config(args):
    ...
    # PREMIUM token: flag wins, else the BOOSTOPT_TOKEN env var (keeps it out of shell history/argv logs)
    cfg.boostopt_token = getattr(args, "boostopt_token", None) or os.environ.get("BOOSTOPT_TOKEN", "") or cfg.boostopt_token
