...
def _common(sp, *, apply: bool = False) -> None:
    ...
    out.add_argument("--boostopt-token", metavar="TOKEN", dest="boostopt_token",
                     help="PREMIUM: entitlement token for --model hosted (or set BOOSTOPT_TOKEN)")
    out.add_argument("--hosted-url", metavar="URL", dest="hosted_url",
                     help="PREMIUM: boostopt_server base URL for --model hosted (default http://127.0.0.1:8724)")
